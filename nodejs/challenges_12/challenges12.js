    ...
    rl.on('line',answer => {
      if ( answer.toLowerCase()==='skip'){
        ...
        if (answer.toLowerCase()===object[number].term.toLowerCase()){
          ...
          count++;
          console.log(
            `\nAnda Kurang beruntung ! anda telah salah ${count}kali,silahkan di coba lagi.`
          );
        }
      }
      rl.prompt();
